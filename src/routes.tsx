...
import { POST_LOGIN_PAGES, PRE_LOGIN_PAGES, UNIVERSAL_ROUTES } from "./constants/pageRoutes";
import { SitemapGroup, type AppRoute } from "./models/AppRoute";

const PreLoginLayout = lazy(() => import("./components/layout/PreLoginLayout"));
const PostLoginLayout = lazy(() => import("./components/layout/PostLoginLayout"));
